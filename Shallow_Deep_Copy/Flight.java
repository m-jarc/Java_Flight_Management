...
public class Flight {
    ...
    //Constructors
    public Flight(String flightID, String destination, int capacity, String priorityCode, FType flightType, String day, String month
            , String year) {
    ...
    public String toString() {
        return flightID + " to " + destination + ", with the capacity of " + capacity + " passengers, " + "has priority code " +
                priorityCode + ", is a " + flightType + "flight and is taking off on " + day + "/" + month + "/" + year;
    }
